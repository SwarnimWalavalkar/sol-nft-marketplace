...
contract Marketplace is ReentrancyGuard {
  ...
  function createMarketItem(
    ...
    require(price > 0, "Price < 1 wei");
    require(msg.value == listingFee, "Price !== listing price");
  ...
  /**
   * @dev Fetches market items according to the its requested address property that can be "owner" or "seller".
   */
